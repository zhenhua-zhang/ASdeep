...
def liftover(item):
    ...
    b37_variant_id = item["variant_id_b37"]

    # Some b38 variants do not have corresponding b37 version.
    if isinstance(b37_variant_id, str):
        b37_chrom, b37_pos, b37_ref, b37_alt, _ = b37_variant_id.split("_")
    else:
        return None
...
def main():
    ...
    kept_cols = ["CHR", "POS", "REF_ALLELE", "ALT_ALLELE", "REF_COUNT",
                 "ALT_COUNT", "TOTAL_COUNT", "TISSUE_ID", "variant_id_b37",
                 "variant_id", "rs_id_dbSNP151_GRCh38p7"]

    output_cols = ["CHR", "POS", "rs_id_dbSNP151_GRCh38p7", "REF_ALLELE",
                   "ALT_ALLELE", "REF_COUNT", "ALT_COUNT", "TOTAL_COUNT"]

    new_name = {"CHR": "contig",
                "POS": "position",
                "rs_id_dbSNP151_GRCh38p7": "variantID",
