...
long_opts="workDir:,genomeDir:,fastqId:,fastqDir:,outFileNamePrefix:,fastqPrefix:,fastqSuffix:,fq1Pattern:,fq2Pattern:,outBAMsortingThreadN:,help"
opt=$(getopt -l $long_opts -- "w:g:i:p:o:P:S:" $@)
eval set -- ${opt}
